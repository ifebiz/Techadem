          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-display font-extrabold leading-tight mb-6">
                Techadem 7-Day Cybersecurity Introductory Class
              </h1>
            ...
            >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Common security threats and how they work",
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <div className="space-y-4 text-foreground/70 text-base md:text-lg leading-relaxed text-left">
                ...
                <p>It is safe to say you can start your journey in Cybersecurity.</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-white/75 text-base md:text-lg mb-10 leading-relaxed">
              Join the full Cybersecurity programme and build skills that can open real doors for you.
            </p>
            <a
              href={WA_ENROLL}
              target="_blank"
              rel="noopener noreferrer"
              data-testid="btn-enroll-cybersecurity"
